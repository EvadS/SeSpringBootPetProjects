package com.se.demo.auth.config;
...
import com.se.demo.auth.DemoAuthInMemoryApplication;
...
@SpringBootTest(webEnvironment = RANDOM_PORT, classes = DemoAuthInMemoryApplication.class)
