                                            ...
                                            <td class="tw-card-body"
                                                ...
                                                <p class=""
                                                   style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                    <span style="font-weight: 400;">Thank you for joining <strong>Monsta Dev team</strong>, an efficient and smart solution to manage your health!</span><br/><br/><span
