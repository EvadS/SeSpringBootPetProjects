...
public class ProfileService {
    ...
    public String createProfileDocument(ProfileDocument document) throws Exception {
        ...
        IndexRequest indexRequest = new IndexRequest(INDEX, Constants.TYPE, document.getId())
                .source(documentMapper);

        IndexResponse indexResponse = client.index(indexRequest, RequestOptions.DEFAULT);

        log.info("Created profile: {}", uuid);
    ...
    public ProfileDocument findById(String id) throws Exception {
        ...
        GetRequest getRequest = new GetRequest(INDEX, Constants.TYPE, id);
