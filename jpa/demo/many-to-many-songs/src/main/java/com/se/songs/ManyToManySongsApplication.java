...
import com.se.songs.repository.AlbumRepository;
import com.se.songs.repository.PeopleRepository;
import com.se.songs.repository.RockGroupsRepository;
import com.se.songs.repository.SongPlayersRepository;
...
public class ManyToManySongsApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ManyToManySongsApplication.class, args);
    }
